...
class ElectraEmbeddings(BertEmbeddings):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        if intermediate_embeddings.requires_grad:
...
class ElectraModel(ElectraPreTrainedModel):
    ...
    Return:
        ...
        #    )
        #else:
        hidden_states, intermediate_embeddings = self.embeddings(
            input_ids=input_ids, position_ids=position_ids, token_type_ids=token_type_ids, inputs_embeds=inputs_embeds
        )
        ...
        #    return hidden_states
        #else:
        return hidden_states, intermediate_embeddings
...
class ElectraForTokenClassification(ElectraPreTrainedModel):
    ...
    Returns:
        ...
        """
        discriminator_hidden_states, intermediate_embeddings = self.electra(
            input_ids,
            attention_mask,
            token_type_ids,
            position_ids,
        ...
        output += discriminator_hidden_states[1:]
        output += (intermediate_embeddings,)
